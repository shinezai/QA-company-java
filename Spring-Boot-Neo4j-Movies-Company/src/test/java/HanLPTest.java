...
public class HanLPTest {
	...
	@Test
	public void TestA(){
		String lineStr = "万科今年的营业收入是多少？";
		try{
			CustomDictionary.add("营业收入","n 0");
	...
	public void TestC() throws Exception{
		...
		String[] questionArr = new String[] {"卧虎藏龙的评分是多少"};
		for(String que: questionArr){
				ArrayList<String> question = query.analyQuery(que);
				System.err.println(question);
		}

//		String sentence = "李连杰与章子怡合作过什么电影？";
//		System.out.println(query.queryAbstract(sentence));
	}
