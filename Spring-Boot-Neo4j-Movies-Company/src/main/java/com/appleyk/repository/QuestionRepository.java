...
public interface QuestionRepository extends GraphRepository<Long> {
	 ...
	 * @return value
	 */
	@Query("match(n:Company)-[:income]-(m:Account) where n.name ={cpname} and m.year ={year} return m.value")
	String getAccountValue(@Param("cpname") String cpname, @Param("year") String year);
